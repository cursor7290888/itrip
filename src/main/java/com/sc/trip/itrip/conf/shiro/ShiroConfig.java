...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        //通过权限注解方法不够灵活  采取过滤器链的方式拦截方法 此处可动态添加权限过滤器链
     ...
     **/
    @Bean
    public SecurityManager securityManager(@Qualifier("shiroRealm") ShiroRealm realm, RedisTemplate<Object, Object> template) {
